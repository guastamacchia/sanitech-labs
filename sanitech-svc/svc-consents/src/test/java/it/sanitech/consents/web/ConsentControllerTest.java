...
class ConsentControllerTest {
    ...
    void checkReturnsResponse() throws Exception {
        String path = AppConstants.ApiPath.API_BASE + AppConstants.ApiPath.CONSENTS_CHECK;
    ...
    void myConsentsUsesPatientClaim() throws Exception {
        String path = AppConstants.ApiPath.API_BASE + AppConstants.ApiPath.CONSENTS_ME;
    ...
    void revokeUsesPatientClaim() throws Exception {
        String path = AppConstants.ApiPath.API_BASE + AppConstants.ApiPath.CONSENTS_ME + "/12/DOCS";
