...
class DepartmentAdminControllerTest {
    ...
    void shouldCreateDepartment() throws Exception {
        ...
        DepartmentDto response = TestDataFactory.departmentDto(7L, "CARD", "Cardiologia");
    ...
    void shouldUpdateDepartment() throws Exception {
        ...
        DepartmentDto response = TestDataFactory.departmentDto(7L, "CARD", "Cardiologia interventistica");
    ...
    void shouldSearchDepartments() throws Exception {
        DepartmentDto department = TestDataFactory.departmentDto(5L, "CARD", "Cardiologia");
