...
class DepartmentServiceTest {
    ...
    void shouldCreateDepartment() {
        ...
        DepartmentDto mappedDto = TestDataFactory.departmentDto(10L, "CARD", "Cardiologia");
    ...
    void shouldUpdateDepartment() {
        ...
        DepartmentDto mappedDto = TestDataFactory.departmentDto(10L, "CARD", "Cardiologia interventistica");
